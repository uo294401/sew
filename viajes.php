...
class Carrusel {
    ...
    public function mostrarCarrusel() {
        ...
        foreach ($this->fotos as $foto) {
            echo "<img src='$foto' style='width: 100%; height: auto; flex-shrink: 0;' alt='Imagen del carrusel'>";
        }
        echo '</figure>';
        echo '<article>';
        echo '<button onclick="moverCarrusel(-1)">Anterior</button>';
        echo '<button onclick="moverCarrusel(1)">Siguiente</button>';
        echo '</article>';
    }
}
class Moneda{
